...
async function searchImages() {
  ...
  // Loop through each result and create a div with an 
  //image and link for each one
  ...
  // Show the "show more" button if there are more than one page
  // of results
  if (page > 1) {
...
// Listen for a submit event on the search form, prevent the 
//default action, and search for images
...
// Listen for a click event on the "show more" button
// and search for more images
